...
from typing import (
    cast, Dict, Hashable, Iterable, List, Optional, Set, Tuple, Union, Sequence, Callable
)
import uuid
import zipfile
...
from smqtk_indexing.utils.metrics import euclidean_distance
...
class IqrSession ():
    ...
    def refine(self) -> None:
        ...
        with self.lock:
            ...
            # Rank the working set descriptors
