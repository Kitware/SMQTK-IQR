...
class IqrService (SmqtkWebApp):
        ...
        merge_dict(c, {
            "iqr_service": {
                ...
                "plugins": {
                    ...
                    "classifier_config":
                        make_default_config(ClassifyDescriptor.get_impls()),
                    "classification_factory":
    ...
    def __init__(self, json_config: Dict):
        ...
        self.session_classifiers: Dict[
            Hashable, Optional[ClassifyDescriptorSupervised]
        ] = {}
    ...
    def _ensure_session_classifier(
        ...
        :param smqtk_iqr.iqr.IqrSession iqrs:
            UUID of the IQR session to use.
        ...
        if self.session_classifier_dirty[sid] or maybe_classifier is None:
            ...
            classifier = cast(ClassifyDescriptorSupervised, maybe_classifier)
